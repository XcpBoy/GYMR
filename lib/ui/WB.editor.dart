          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Row 1: LOAD, ISO, UNI, FIELD — evenly distributed across full width
                Row(
                  children: [
                    Expanded(
    ...
    while (i < sets.length) {
      ...
      if (widget.exercise.isUnilateral &&
        ...
        if (nMeta["side"] == "LEFT") {
          ...
          items.add(_UnilateralPairFrame(
...
class _WorkoutSetInstanceState extends ConsumerState<_WorkoutSetInstance> {
  ...
  void _initControllers(WorkoutSet set) {
    ...
    _tC = TextEditingController(
        text: (set.trackName ?? '').replaceAll('[RED_PR]', '').trim());
    _rsC = TextEditingController(text: set.restTimeSeconds?.toString() ?? '0');
    ...
    _fC = TextEditingController(
        text: set.restTimeSeconds != null
            ? (set.restTimeSeconds! / 10).toString()
            : '');
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(label,
                style: LabStyles.mono(context, fontSize: 7, color: color),
                textAlign: TextAlign.center,
                maxLines: 1),
          ],
        ),
