...
final Map<String, String> esTranslations = {
  ...
  // --- sleep_tracker_screen.dart (SLPTRCKR) ---
  'HOW_WAS_YOUR_SLEEP': '¿CÓMO SENTISTE EL SUEÑO?',
  'VERY_BAD': 'MUY MAL',
  'EXCELLENT': 'EXCELENTE',
  'SKIP': 'OMITIR',
  'IN_BED_SINCE': 'EN CAMA DESDE LAS',
  'PAUSED': 'EN PAUSA',
  'WAKE_UP': 'ME LEVANTO',
  'GO_TO_BED': 'ME ACUESTO',
  'PAUSE': 'PAUSAR',
  'AVERAGE': 'PROMEDIO',
  'MEDIAN': 'MEDIANA',
  'STD_DEV': 'DESV. EST.',
  'NIGHTS': 'NOCHES',
  'NO_RECORDS_IN_RANGE': 'SIN REGISTROS EN ESTE RANGO',
  'RECORDS': 'REGISTROS',
  'NO_SLEEP_RECORDS_YET': 'SIN REGISTROS DE SUEÑO TODAVÍA',
  'EDIT_RECORD': 'EDITAR REGISTRO',
  'BED_TIME': 'HORA DE INICIO',
  'WAKE_TIME': 'HORA DE FIN',
  'IN_PROGRESS': 'EN CURSO',
  'SAVE_CHANGES': 'GUARDAR CAMBIOS',
  '08 SLPTRCKR': '08 SLPTRCKR',
